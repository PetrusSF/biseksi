...
<div class="container">
<p>
  Carilah akar persamaan <strong>f(x) = e<sup>x</sup> - 5x<sup>2</sup></p>
<?php
	//----Fungsi menentukan persamaan
	function persamaan($x)
		{
			return pow(M_E,$x) - 5 * pow($x,2);
		}
...
<table class="f_isian">
      ...
      <tr>
		...
		<td><input class="btn btn-primary" type="submit" name="button" id="button" value="reset" /></td>
      </tr>
  </table>
  </form>
<?php
